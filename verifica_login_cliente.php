<?php
    ...
    if (is_null($_GET['email']) || $_GET['email'] == '' || is_null($_GET['senha']) || $_GET['senha'] == '') {
        ...
        $sql = 'SELECT id , email , senha , idHierarquia , nome , ativo FROM Users WHERE email = \''.$_GET['email'].'\';';
    ...
    $senhaCorreta = passwordCheckcliente($_GET['senha'], $r['senha']);
