...
;';
	...
	$sql = 'INSERT INTO Compras_X_Produtos (idCompra , idProduto , idCorTampa , qtde, idProjeto, valor )
	SELECT '.$idCompra.' idCompra , c.idProduto , c.idCorTampa , c.qtde , c.idProjeto,
	  (SELECT (valorUnitario - (valorUnitario * '.$valor.')) FROM PrecosQuantidades WHERE idProduto = c.idProduto AND qtde >= c.qtde ORDER BY valorUnitario DESC LIMIT 1) valorUnitario 
	FROM Carrinho c
	JOIN Produtos p ON p.id = c.idProduto
	WHERE idUser = '.$_SESSION['idUser'].'
	ORDER BY valorUnitario DESC
														...
														<form id="payment-form" action="<?php echo $site;?>pagamentocc" method="POST">
															...
															<div class="form-group row">
																<div class="col-sm-12 text-center">
																	<br>
																	<div style="clear: both"></div>
																	<div class="pull-center"><button class="btn btn-primary btn-lg" onclick="dasabilitaBotao(this)" id="send"  name="send" type="submit" >  Efetuar pagamento &nbsp; <i class="fa fa-arrow-circle-right"></i> </button></div>
...
?>
                ...
                <div class="w100 cartMiniTable">
                    <table id="cart-summary" class="std table">
                        ...
                        <tr>
                            <td> Total </td>
                            <td class=" site-color" id="total-price"><?php echo formata_real($carrinho->getSubTotal() - ($carrinho->getSubTotal() * $valor) + $carrinho->getFrete()); ?></td>
              ...
              <div class="cartContent table-responsive  w100">
                <table style="width:100%" class="cartTable cartTableBorder">
                  <tbody>
                    ...
                    <?php
                    $sql = 'SELECT cp.idProduto ,p.url, p.titulo , p.img , cp.qtde , cor.cor, cp.valor, (cp.qtde*cp.valor) tot, p.estoque, p.quantidade
...
<!-- /.main-container -->
	...
	================================================== -->
<script>
var formID = document.getElementById("payment-form");
var send = $("#send");
