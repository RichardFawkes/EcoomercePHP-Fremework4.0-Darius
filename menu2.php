    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title-site text-center"> Faça Login </h3>
            </div>
            <div class="modal-body">
                
		<form method="post" action="<?php echo $site; ?>verifica_login2.php?id=<?php echo $_GET['id']; ?>&url=<?php echo $d['url']; ?>">
...
<div class="navbar navbar-tshop  megamenu  " role="navigation">
    ...
    color:white
        ...
        echo '
        <ul class="userMenu">
        <li><a href="#" data-toggle="modal" data-target="#ModalLogin"> <span class="hidden-xs"> <i class="fa fa-user"></i>Olá,<span style="  font-weight: bold;
        "> Visitante</span></span>

          <i class="glyphicon glyphicon-log-in hide visible-xs "></i> </a></li><li><a href="#" data-toggle="modal" data-target="#ModalLogin"> <span class="hidden-xs">Entrar</span>
...
<li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <?php
                                $sql = 'SELECT * FROM Categorias WHERE ativo = 1 AND idTipo = 1 AND mailcliente IS NULL';
                                ...
                                if ($nr > 0) {
                                    ...
                                    while ($r = mysqli_fetch_assoc($q)) {
                                        echo '          <a style="font-weight:bold; text-transform: uppercase;"  class="dropdown-item" 
 href="'.$site.'Categoria/'.$r['urlLink'].'">&nbsp;&nbsp;'.$r['categoria'].'</a><br>';
                                    }
                                }
...
<?php /*                           <a class="btn btn-sm btn-danger" href="<?php echo $site; ?>carrinho"> <i class="fa fa-shopping-cart"> </i> VER CARRINHO </a> */ ?>
                ...
                <div class="buscador">
                    <div class="input-group">
                        <button class="btn btn-nobg getFullSearch" type="button" ><i class="fa fa-search"> </i> BUSCAR</button>
                    </div>
                    <!-- /input-group -->
