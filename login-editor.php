...
$sql = 'SELECT nome From `Users` WHERE id = '.$_SESSION["idUser"].' AND nome IS NOT NULL;';
...
//existe
    ...
    echo '<script>
	window.location.href = "'.$editor.''.$_GET['id'].'&tpsc=1&cru='.$site.'api%2Fcriar-order.php%3Fepi%3D'.$_GET['id'].'%26url%3D'.$d['url'].'";
	</script>';
}
