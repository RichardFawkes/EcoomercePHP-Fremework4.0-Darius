<?php
    ...
    $urls = 'https://api.printnow.com/api/v1/pipo/order/'.$results.'/process';
...
header('Location:'.$site.'api/ftpdow.php?order='.$results.'&id='.$id.'&url='.$_GET['url'].'');
//header('Location:'.$site.'produtou/'.$epi.'?id='.$id.'');
?>
