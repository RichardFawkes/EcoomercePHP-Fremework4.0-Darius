          ...
          while($r = mysqli_fetch_assoc($q)){
           ...
           $totals = ($rFrete['preco_frete']) +  ($rFrete['preco_frete']);
            ...
            <tr style="border-collapse:collapse;">
             ...
             <td width="20%" style="padding:0;Margin:0;"><h4 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:\'open sans\', \'helvetica neue\', helvetica, arial, sans-serif;">R$ '.number_format($totals, 2).'</h4></td>
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             <td width="70%" style="padding:0;Margin:0;"><h4 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:\'open sans\', \'helvetica neue\', helvetica, arial, sans-serif;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FRETE:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h4></td>
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
