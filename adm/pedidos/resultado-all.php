...
<div class="wrapper">
	...
	<h4 class="page-title">Relatorio de Pedidos Data/Pago:</h4>


	<form method="POST" action="resultado.php" >

	
<h4 class="page-title">Exporta  <a class="btn btn-primary" href="exporta-relatorio-all.php?pago=<?php echo $_POST['pago']?>&datainicio=<?php echo $_POST['datainicio']?>&datafinal=<?php echo $_POST['datafinal']?>"> <i class="fa fa-download"></i> Exportar em .CSV</a></h4>
...
<br>
   ...
   $pago =  $_POST['pago'];
							...
							WHERE pago = '.$pago.' and DATE( c.dataHora ) between "'.$datainicio.'" and "'.$datafinal.'"
