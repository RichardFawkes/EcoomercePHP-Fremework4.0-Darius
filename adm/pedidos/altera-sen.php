...
$sql = 'SELECT enviado,codigoRastreio FROM Compras WHERE id='.$_GET['id'].';';
...
if($row['enviado']==1){
  ...
  if($q){
    ...
    $rowStatus = mysqli_fetch_array($resStatus);
                                   ...
                                   <td width="530" valign="top" align="center" style="padding:0;Margin:0;">
                                    <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                      <tbody><tr style="border-collapse:collapse;">
                                       ...
                                       <img src="http://www.lojadalata.com/images/transmail.jpg" title="Loja da lata">
                                       <h1> Caro Cliente, '.$rowInfo['nome'].' obrigado por finalizar sua compra<br/></h1>
                                      <h2> O número do seu pedido é:     #'.$_GET['id'].'<br/></h2>
                                       <h2 > Teve o status alterado para:</h2> <h1 style="color:green;"> PRODUTO ENVIADO!</h1><h1 style="color:blue">'.$row['codigoRastreio'].'</h1>
     ...
     $mail->AltBody = 'Status do Pedido #'.$_GET['id'].'';
...
$upd = 'UPDATE Compras SET enviado='.$status.' WHERE id='.$_GET['id'].';';
