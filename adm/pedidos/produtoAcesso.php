    ...
    <br class="hidden-md hidden-lg" />
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<a href="produtoAcesso.php" class="badge badge-success">TOTAL MAIS VISITADOS</a>
					<a href="produtoAcesso30.php" class="badge badge-success">ULTIMOS 30 DIAS</a>
					<a href="produtoAcesso15.php" class="badge badge-success">ULTIMOS 15 DIAS</a>
					<a href="produtoAcesso5.php" class="badge badge-success">ULTIMOS 5 DIAS</a>
<br>
<br>
				</div>
			</div>
