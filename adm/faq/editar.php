          ...
          <form method="POST" action="alterar.php" enctype="multipart/form-data">
            <div class="row">
              <div class="form-group  col-md-12">
                ...
                <textarea placeholder="Pergunta" class="form-control" name="pergunta" /><?php echo $row['pergunta']?></textarea>
              </div>
            ...
            <div class="row">
              <div class="form-group  col-md-12">
                ...
                <textarea placeholder="Resposta" class="form-control" name="resposta" id="resposta"/><?php echo $row['resposta']?></textarea>
              </div>
