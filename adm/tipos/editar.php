...
<?php
$sql = 'SELECT * FROM Tipos_ WHERE id ='.$_GET['id'];
...
<div class="wrapper">
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-12">
        <h4 class="page-title">Tipos de Personalizacao </h4>
          ...
          <form method="POST" action="alterar.php" enctype="multipart/form-data">
            <div class="row">
              <div class="form-group  col-md-12">
                ...
                <textarea placeholder="Título do Tipo" class="form-control" name="titulo" /><?php echo $row['categoria']?></textarea>
              </div>
            ...
            <div class="row">
              <div class="col-xs-12 col-md-12">
                <?php
                if ($row['img']!="") {
                    echo "<img src='".$site."/images/tipos/".$row['img']."' class='thumb-image' id='photo'/>";
                }
                ?>
