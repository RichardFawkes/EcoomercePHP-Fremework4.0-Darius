...
<div class="wrapper">
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12">
				<h4 class="page-title">Tipos de Personalizacao <a href="cadastrar.php" class="btn btn-primary"><i class="fa fa-plus"></i> Cadastrar</a></h4>
						...
						<tbody>
							<?php
                                ...
                                while ($row = mysqli_fetch_array($res)) {
                                    ...
                                    echo "<td width='5%'><a href='".$site."images/tipos/".$row['img']."' style='cursor:zoom-in;' target='_blank'><img src='".$site."images/tipos/".$row['img']."' class='img-responsive' /></a></td>";
