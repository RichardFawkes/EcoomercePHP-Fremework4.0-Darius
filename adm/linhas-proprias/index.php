...
<div class="wrapper">
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12">
				<h4 class="page-title">Linhas Próprias <a href="cadastrar.php" class="btn btn-primary"><i class="fa fa-plus"></i> Cadastrar</a></h4>
			...
			<div class="row">
				<div class="card-box">
					<table id="tabela" class="table table-striped">
						...
						<tbody>
							<?php
								$sql = 'SELECT id, categoria, urlLink, ativo, img, urlLink link
								FROM Categorias c
								WHERE idTipo=2
								ORDER BY c.id DESC;';
								...
								while($row = mysqli_fetch_array($res)){
									...
									echo "<td width='5%'><a href='".$site."images/product/linhas_proprias/".$row['img']."' style='cursor:zoom-in;' target='_blank'><img src='".$site."images/product/linhas_proprias/".$row['img']."' class='img-responsive' /></a></td>";
