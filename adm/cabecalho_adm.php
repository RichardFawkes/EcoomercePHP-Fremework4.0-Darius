...
<head>
	...
	<!-- <link href="<?php echo $rot;?>assets/plugins/datatables/jquery.dataTables.min.css" rel="stylesheet" type="text/css"/> -->
	<!-- <link href="<?php echo $rot;?>assets/plugins/datatables/dataTables.bootstrap.min.css" rel="stylesheet" type="text/css"/> -->
	<!-- SELECT 2 -->
			...
			<div class="rmm style">
				...
				<ul>
					...
					<li>
						...
						<li><a class="" href="<?php echo $rot;?>pedidos/pedidos2"><span>Consultar Pedidos Manual</span></a></li>
					...
					<li><a class="" href="<?php echo $rot;?>sair.php"> <span><i class="ti-power-off m-r-5"></i>Logout</span></a></li>
				</ul>
				<!-- End navigation menu  -->
