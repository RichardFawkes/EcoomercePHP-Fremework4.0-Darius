...
<button onclick="goBack();" style=" background:#10c469; height:30px; width:100px; font-size:17px; text-align: center;" class="badge badge-success badge-lg"><i class="fa fa-arrow-circle-left"></i>VOLTAR</button>
  ...
  //      $row2 = mysqli_fetch_array($res2);
      ...
      $sql4= 'SELECT * From Cupons ORDER BY id ASC;';
    ...
    ?>              
        ...
        Tabela de Cupons <?php echo date('yy-m-d')?> <i class="fa fa-tags"></i>
            </h3>
      </div>
...
<form method="POST" action="inserecupon.php" >
   ...
   <table  class="table table-dark table-responsive-md table-striped text-center card-box">
     ...
     <tbody>
       <tr>
         ...
         <td> <input type="text" placeholder="Nome do Cupom" class="form-control" name="cupomName"></td>
         <td><input type="date" placeholder="Data-Inicio" class="form-control" name="dataInicio"></td>
		 <td><input type="date" placeholder="Data-Final" class="form-control" name="dataFinal"></td>
         <td><input type="text" placeholder="Desconto %(0.00)" class="form-control porce" name="valor"></td>
		 <td><input type="text" placeholder="Valor Minimo" class="form-control money" name="valorMinimo"></td>


		
		 <td><select name="fretegratis" class="form-control" >
...
<input type="submit" class="btn btn-success" value="Cadastrar"/>         
       ...
       <?php foreach($res3 as $repete){
         ...
         echo '
         <tr>
         <td class="pt-3-half" style="font-weight: bold;" contenteditable="true"><i class="fa fa-tag"></i> ' . $repete['cupomName'] .'</td>

		 <td class="pt-3-half" style="font-weight: bold;" contenteditable="true">'. $repete['dataInicio'] .'</td>
		 
		 <td class="pt-3-half" style="font-weight: bold;" contenteditable="true">'. $repete['dataFinal'] .'</td>

		 <td class="pt-3-half" style="font-weight: bold;" contenteditable="true">'. $repete['valor'] .'%</td>

     <td class="pt-3-half" style="font-weight: bold;" contenteditable="true">'.formata_real($repete['valorMinimo']) .'</td>
     
'
		 
		 ;
		 
		   if($repete['fretegratis'] == 0){
			echo'
		 <td class="pt-3-half" style="font-weight: bold;" contenteditable="true">NAO</td>

	  ';}
	  else{
		echo'
		<td class="pt-3-half" style="font-weight: bold;" contenteditable="true">SIM</td>
 ...
 <form action="editar.php" method="POST">
         ...
         <button name="editar" type="submit" class="btn btn-warning  btn-block">  <i class="fa fa-pencil-square"></i>
         <input type="hidden" placeholder="" class="form-control" name="id" value='.$repete['id'].'>
