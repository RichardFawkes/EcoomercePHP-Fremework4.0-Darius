...
$(document).ready(function () {
    ...
    /*=======================================================================================
     ...
     ========================================================================================*/
        ...
        function equalHeightCategory(){
            $('.equalheightItem > .item').matchHeight({byRow: true})
            $('.equalheightItemx').each(function(i, elem) {
                $(elem)
    ...
    window.addEventListener("orientationchange", function() {
        ...
        $('.equalheightItexm > .item').matchHeight({byRow: true})
    ...
    $(".change-view .list-view, .change-view-flat .list-view").click(function (e) { //use a class, since your ID gets mangled
       ...
       // $('.categoryProduct > .item').responsiveEqualHeightGridDestroy();
       // $('.categoryProduct > .item').responsiveEqualHeightGrid();
        // equalHeightCategory();
    });
...
/*
    $(".change-viewx .grid-view, .change-view-flatx .grid-view").click(function (e) { //use a class, since your ID gets mangled
        e.preventDefault();
        $('.categoryProduct > .item').removeClass("list-view"); //add the class to the clicked element
