...
<?php
    if (!isset($_SESSION['tempUser'])) {
        ...
        echo '<li><a href="#" data-toggle="modal" data-target="#ModalLogin"> <span class="hidden-xs ">Entrar Cliente </span>
          <i class="glyphicon glyphicon-log-in hide visible-xs "></i> </a></li>
          <li class="hidden-xs"><a href="#" data-toggle="modal" data-target="#ModalSignup"> <span class="hidden-xs">Cadastrar Cliente</span>
					<i class="glyphicon glyphicon-log-in hide visible-xs "></i> </a></li>';
    }
