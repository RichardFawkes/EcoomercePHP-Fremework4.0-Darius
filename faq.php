  ...
  <div class="row transitionfx">
    <div class="container">
        <div class="row">
          ...
          <?php
            $cont = 0;
            $sql = 'SELECT * FROM Faq WHERE ativo =1 ';
             ...
             <div class="panel panel-default">
                      <div class="panel-heading">
                          <h4 class="panel-title">
                            <a data-toggle="collapse" href="#collapse<?php echo $cont;?>" class="collapseWill collapsed" aria-expanded="false">
                              <i class="fa fa-caret-right"></i> <?php echo $row['pergunta']; ?>
                            </a>
                            </h4>
                      </div>
                      <div id="collapse<?php echo $cont;?>" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                          <div class="panel-body" id="resposta">
         ...
         echo '<div class="col-xs-12 col-sm-6"><p>Nenhuma Questão disponível.</p></div>';
       }
         ?>
        </div>
    </div>
